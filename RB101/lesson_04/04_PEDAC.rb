...
# Explicit Rules
#   - return only series of characters that are palindrones
#   - be case sensitive in evaluating palindrones
#   - if there on no palindrones, return an empty string
#   - the return value should not be the same as input value
...
puts palindrome_substrings('Mom, dad, sister, brother')